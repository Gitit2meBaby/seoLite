...
export const schemaTypes = {
  ...
  Organization: {
    ...
    fields: [
      ...
      "telephone",
      "address",
      "sameAs", // ✅ Correct - Organizations have authoritative profiles
      "foundingDate",
      "numberOfEmployees",
      "areaServed",
      "openingHours",
  ...
  LocalBusiness: {
    ...
    fields: [
      ...
      "telephone",
      "address",
      "sameAs", // ✅ Correct - Local businesses have profiles
      "openingHours",
      "hasOfferCatalog",
  ...
  Restaurant: {
    ...
    fields: [
      ...
      "telephone",
      "address",
      "sameAs", // ✅ Restaurant social profiles
      "openingHours",
      "servesCuisine",
      "acceptsReservations",
      "menuUrl",
  ...
  Article: {
    ...
    fields: [
      ...
      "wordCount",
      "articleBody",
      // ❌ Removed sameAs - articles don't have social profiles
    ],
  },
  ...
  NewsArticle: {
    ...
    fields: [
      ...
      "wordCount",
      "dateline",
      // ❌ Removed sameAs - news articles don't have profiles
    ],
  },
  ...
  Service: {
    ...
    fields: [
      ...
      "aggregateRating",
      "review",
      // ❌ No sameAs for individual services
    ],
  },
  ...
  Person: {
    ...
    fields: [
      ...
      "jobTitle",
      "worksFor",
      "sameAs", // ✅ Correct - People have social profiles
      "birthDate",
      "nationality",
      "alumniOf",
    ],
  ...
  Event: {
    ...
    fields: [
      ...
      "eventAttendanceMode",
      "image",
      // ❌ Events typically don't have sameAs
    ],
  },
  ...
  Recipe: {
    ...
    fields: [
      ...
      "nutrition",
      "aggregateRating",
      // ❌ Individual recipes don't have sameAs
    ],
  },
  ...
  WebSite: {
    ...
    fields: [
      ...
      // ❌ Removed sameAs - use publisher.sameAs instead
    ],
  },
  ...
  WebPage: {
    ...
    fields: [
      ...
      "dateModified",
      "author", // Links to Person
      // ❌ Individual pages don't have sameAs
    ],
  },
};
